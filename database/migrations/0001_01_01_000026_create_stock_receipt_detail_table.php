    ...
    public function up(): void
    {
        Schema::create('stock_receipt_detail', function (Blueprint $table) {
            ...
            $table->string('serial_number_snapshot', 100)->nullable()
                  ->comment('Snapshot mã Sê-ri tại thời điểm nhập — dùng để hiển thị lịch sử khi serial_id đã bị xóa (phiếu Cancelled được dọn dẹp), không phụ thuộc bản ghi serials gốc còn tồn tại hay không');
