...
class UpdateUomRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code'   => "required|string|max:20|regex:/^[A-Za-z0-9]+$/|unique:uoms,code,{$uomId}", //UPDATE
    ...
    public function messages(): array
    {
        return [
            ...
            'code.regex'      => 'Mã đơn vị tính chỉ được phép chứa chữ cái và số, không chứa ký tự đặc biệt.', // UPDATE
